...
Original file is located at
    https://colab.research.google.com/drive/1PFwkDepTS5aMq6I5yj62L0jaYqeIpq7b
"""
...
print(voca_size, embedding_size)
# cnn 모델 생성
model = Sequential()
...
history = model.fit(x_train, y_train, batch_size=128, epochs=50, validation_data=(x_train[:10000], y_train[:10000]))
model.summary()
