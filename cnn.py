...
Original file is located at
    https://colab.research.google.com/drive/1zQbX3pV56URs-3DoOHCGWCTVeAbCg8M6
"""
...
from keras.layers import Dense, LSTM, Embedding, Flatten, Dropout, Conv1D, MaxPooling1D
...
model.add(Embedding(len(index_to_word), 120, input_length=max_len))
...
history = model.fit(x_train, y_train, batch_size=500, epochs=10, validation_data=(x_train[:10000], y_train[:10000]))
